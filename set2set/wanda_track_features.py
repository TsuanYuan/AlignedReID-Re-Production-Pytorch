...
if __name__ == "__main__":
    ...
    ap.add_argument("--gpu_id", type=int, help="gpu_device")
    ap.add_argument("--start_line", type=int, help="line to start")
    ap.add_argument("--last_line", type=int, help="last line to process")
    ap.add_argument("--sample_size", type=int, help="num per track")
    args = ap.parse_args()
