...
class Dataset(object):
  ...
  def __init__(
    ...
    pre_process_im_kwargs.pop('group_file', None)
    pre_process_im_kwargs.pop('customized_id_folder_path', None)
    pre_process_im_kwargs.pop('customized_noid_folder_path', None)
